...
cat("Общее количество уникальных IP-адресов:", length(all_unique_ips), "\n")
```
...
top_active_sources <- dns_data_clean %>%
  ...
  slice(1:10)
cat("Топ-10 активных источников:\n")
...
top_10_domains <- dns_data_clean %>%
  ...
  slice_head(n = 10)
cat("Топ-10 запрашиваемых доменов:\n")
...
cat("Статистика временных интервалов:\n")
...
cat("Обнаружена периодическая активность:\n")
